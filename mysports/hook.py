...
Java.perform(function () {
    ...
    Java.choose("com.example.gita.gxty.ram.MyRuningActivity$k", {
        onMatch: function (instance) {
            var cbInstance = Java.use('com.example.gita.gxty.ram.MyRuningActivity$k').$new();
            a0(instance, cbInstance);
            cbInstance = Java.use('com.example.gita.gxty.ram.MyRuningActivity$k').$new();
            a0(instance, cbInstance);
        },
        onComplete: function () {
